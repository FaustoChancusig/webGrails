...
<div class="btn-toolbar toolbar">
    ...
    <div class="btn-group">
        <g:link controller="canton" action="buscar" class="btn btn-warning">
            <i class="fa fa-bars"></i> Buscar Cantones
        </g:link>
    </div>
</div>
            ...
            buttons: {
                ...
                eliminar: {
                    ...
                    callback: function () {
                        $.ajax({
                            type: "POST",
                            url: '${createLink(controller: 'provincia', action:'delete_ajax')}',
                            data: {
                                id: itemId
                            },
                            success: function (msg) {
