...
<div class="btn-toolbar toolbar">
    ...
    <div class="btn-group">
        <a href="#" class="btn btn-primary btnCrear">
            <i class="fa fa-clipboard-list"></i> Nuevo Producto
        </a>
    </div>
</div>
...
<div id="tabla_ajax">
    <g:render template="buscar_ajax" model="[productos: productos]" />
</div>
...
<script type="text/javascript">
    ...
    function deleteRow(itemId) {
        bootbox.dialog({
            title: "Alerta",
            message: "<i class='fa fa-trash fa-3x pull-left text-danger'></i><p>¿Está seguro que desea eliminar el producto seleccionado?</p>",
            closeButton: false,
            buttons: {
                cancelar: {
                    label: "Cancelar",
